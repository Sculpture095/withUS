...
public interface ProjectMapper {
    ...
    @Mappings({
            ...
            @Mapping(target = "projectName", source = "projectName"),
            @Mapping(target = "proStatement", expression = "java((dto.getProStatement() == null || dto.getProStatement().trim().isEmpty()) ? com.withus.project.domain.projects.ProjectStatus.ON_GOING : com.withus.project.domain.projects.ProjectStatus.valueOf(dto.getProStatement()))"),
