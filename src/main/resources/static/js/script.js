...
function updateSelectedOptions(customSelect){
    ...
    document.addEventListener("click", function(event){
        ...
        if(removeTag){
            ...
            const otherSeletedOptions = customSelect.querySelectorAll(".option.active:not(.all-tags)");
            const allTagsOption = customSelect.querySelector(".option.all-tags");

            if(otherSeletedOptions.length === 0){
    ...
    // const submitButton = this.document.querySelector(".reg_btn");
